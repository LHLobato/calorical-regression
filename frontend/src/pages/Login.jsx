    ...
    <div className="login-page">
      ...
      <div className="login-container">
        <div className="login-header">
          ...
          <h1>
            <span>Caloric</span> Regression
          </h1>
          <p>Transforme sua saude com inteligencia nutricional</p>
        </div>

        <div className="login-card">
          <h2>Bem-vindo de volta!</h2>
          <p className="login-subtitle">Facil login para continuar sua jornada</p>
          ...
          <p className="login-footer">
            Nao tem uma conta? <Link to="/register">Criar conta gratuita</Link>
          </p>
        </div>
      </div>
    </div>
